...
torchrun --nnodes 3 --nproc_per_node 8\
    ...
    fastvideo/distill_dcm_hy_detail_expert.py \
    --seed 42\
    --pretrained_model_name_or_path path_to_semantic_expert \
    ...
    --cfg 0.0 \
    --log_validation \
    --output_dir data/outputs/distill_hy_detail \
    --tracker_project_name distill_hy_detail \
    --num_height 720 \
    --num_width 1280 \
    --num_frames 29 \
    ...
    --not_apply_cfg_solver --use_cpu_offload 
