...
parser.add_argument("--step", type=int, default=2, help="denosing steps")
parser.add_argument("--noise_scale", type=float, default=0.8, help="initial noise scale")
...
parser.add_argument("--schedule_block", action="store_true", default=False, help='whether to use blocking schedule for optimal blocks partitioning')
